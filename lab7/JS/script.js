...
function pokazGalerie() {
  ...
  for (let i = 1; i <= 10; i++) {
    tresc += '<div class="slajd"> <img src="../Pictures/miniaturki/obraz'+ i + '.JPG" alt="Zdjecie"></img></div>';
  }
  return tresc + '</div>'
}
